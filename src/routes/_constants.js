const strings = {
  ...
  description: "Un generador simple de patrones en línea para crear patrones SVG.",
  description2: "Acelere su sitio web sin comprometer la calidad de imagen..",
  description3: "Perfecto para fondos de sitios web, ropa, marcas, diseño de embalaje y mucho más.",
  keywords: "patrones svg, patrones, fondos de svg, fondos de pantalla vectoriales, generador de patrones, creador de patrones",
  pages: [
    {
      page: "index",
